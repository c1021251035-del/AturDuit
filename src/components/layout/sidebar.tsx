...
export function Sidebar() {
  ...
  return (
    <nav className="nike-card-divided flex flex-col h-full border-r border-[var(--hairline)]">
      {/* Logo */}
            ...
            return (
              <li key={href}>
                <Link
                  href={href}
                  className={cn(
                    "nike-primary-nav-link flex items-center gap-3 px-3 py-3 w-full text-left transition-colors duration-150",
                    isActive ? "font-medium" : "text-[var(--mute)] hover:text-[var(--ink)]"
                  )}
                >
